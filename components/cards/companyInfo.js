    ...
    <div>
      <div className="flex justify-start">
        ...
        <div className="item w-full">
          ...
          <button className="block py-1 px-10 mt-1 bg-primary text-gray-400 text-xs font-semibold rounded-full hover:text-white focus:outline-none">
            Send
          </button>
        </div>
      </div>
