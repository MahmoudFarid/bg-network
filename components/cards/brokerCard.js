...
export default function BrokerCard({ broker }) {
  ...
  return (
    <div className="flex justify-start border border-gray-200 shadow-lg rounded-lg p-5 mb-5 hover:border-primaryText">
