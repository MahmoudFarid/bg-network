...
export default function AdvancedFilter({
  ...
  return (
    <form
      className="bg-white z-50 absolute top-0 right-0 w-5/12 h-screen transition duration-500 ease-in-out origin-top-right scale-150 p-5"
      ...
      <div className="flex justify-between border-b-2 border-gray-200 py-2 pt-0 mb-3">
        ...
        <i
          className="fas fa-times fa-2x text-gray-400 cursor-pointer transition duration-500 ease-in-out hover:text-primaryLight"
          onClick={onAdvancedSearch}></i>
      </div>
